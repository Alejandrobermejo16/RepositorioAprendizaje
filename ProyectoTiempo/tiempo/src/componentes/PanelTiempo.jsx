...
const PanelTiempo = () => {
  ...
  return (
    ...
    <React.Fragment>
      ...
      />
      <Tarjeta
        //le vamos a pasar unas props 
        showData={show}  //controlaremos que se vean los datos
        loadingData={loading} //vamos a controlar que se vea el spinner
        tiempo={tiempo} //vamos a pasarle a la tarjeta el pronostico del tiempo y de las siguientes horas
        forecast={forecast} //se obtiene con el hook de arriba tanto el tiempo como forecast
